...
lodNB = cent(norm(log(odNB))); 
lodBB = cent(norm(log(odBB))); 
...
plot(density(lodNB), bty="n", main="log10(NB OD)", xlab="log(od)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
plot(density(lodBB), bty="n", main="log10(BB OD)", xlab="log(od)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
plot(density(lodR), bty="n", main="log10(RASQ OD)", xlab="log(od)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(lodNB, lodBB, main="NB vs BB over-disp", xlab="log(NB OD)", ylab="log(BB OD)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(lodNB, lodR, main="NB vs Rasq over-disp", xlab="log(NB OD)", ylab="log(RASQ OD)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(lodR, lodBB, main="Rasq vs BB over-disp", xlab="log(RASQ OD)", ylab="log(BB OD)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
...
smoothScatter(asT, asR, bty="n", main="#as-RASQ vs #as-TReCASE", 
...
smoothScatter(rasq$tnlt, rasq$rnlt, bty="n", main="RASQUAL vs TReCASE p-val", 
...
smoothScatter(lodNB, y, main="discrep. vs log(NB)", ylab="diff", 
              xlab="log(NB OD)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(lodBB, y, main="discrep. vs log(BB)", ylab="diff", 
              xlab="log(BB OD)", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(NfSNP, y, main="discrep. vs #fSNP", ylab="diff", 
              xlab="num-fSNP", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(asR, y, main="discrep. vs ASReC-RL cnt", ylab="diff", 
              xlab="ASReC-RL", cex.main=cexes, cex.lab=cexes,cex.axis=cexes)
smoothScatter(asT, y, main="discrep. vs ASReC-TR cnt", ylab="diff", 
              xlab="ASReC-TR", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
smoothScatter(mpp, y, main="discrep. vs med. per. p-val", ylab="diff", 
              xlab="med. per. p-val", cex.main=cexes, cex.lab=cexes, cex.axis=cexes)
