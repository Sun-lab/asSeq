...
#liftover to hg38
  system(sprintf('cd %s ;/fh/fast/sun_w/bin/liftOverLinux/liftOver combined.txt /fh/fast/sun_w/bin/liftOverLinux/hg19ToHg38.over.chain combined_hg38.txt combined_unlifted.txt', sam))
