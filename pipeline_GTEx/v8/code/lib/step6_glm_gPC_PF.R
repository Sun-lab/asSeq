...
write.csv(resL1.bb, sprintf("%s/%s_long_vglm_gPC_PF.csv", out.dir, mod), quote=F)
write.csv(resS1.bb, sprintf("%s/%s_short_vglm_gPC_PF.csv", out.dir, mod), quote=F)

write.csv(resL1.qp, sprintf("%s/%s_long_glmqp_gPC_PF.csv", out.dir, mod), quote=F)
write.csv(resS1.qp, sprintf("%s/%s_short_glmqp_gPC_PF.csv", out.dir, mod), quote=F)

write.csv(resL1.bin, sprintf("%s/%s_long_glmbin_gPC_PF.csv", out.dir, mod), quote=F)
write.csv(resS1.bin, sprintf("%s/%s_short_glmbin_gPC_PF.csv", out.dir, mod), quote=F)
