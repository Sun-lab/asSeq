#sbatch -p general -N 1 -t 03-00:00:00 --begin=22:00:00 -o step2_submit_trecaseAlong5e5.out --mem=8g --wrap="R CMD BATCH step2_submit_trecaseAlong5e5.R step2_submit_trecaseAlong5e5.Rout"
