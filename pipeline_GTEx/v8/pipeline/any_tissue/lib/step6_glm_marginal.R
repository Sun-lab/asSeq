...
#reformulate with relative path to Annotations
#v8 dir needs to be added to get annotation path 
v8.dir = "/pine/scr/z/h/zhabotyn/R01/GTEx/v8"
tis.dir = sprintf("%s/2020_01_20/%s", v8.dir, pref)
out.dir = sprintf("BetaBin_marginal")
...
write.csv(resL1.bb, sprintf("%s_long_vglm_ohet.csv", out.dir, mod), quote=F)
write.csv(resS1.bb, sprintf("%s_short_vglm_ohet.csv", out.dir, mod), quote=F)

write.csv(resL1.bin, sprintf("%s_long_glmbin_ohet.csv", out.dir, mod), quote=F)
write.csv(resS1.bin, sprintf("%s_short_glmbin_ohet.csv", out.dir, mod), quote=F)
