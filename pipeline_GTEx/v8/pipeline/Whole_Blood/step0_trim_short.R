#sbatch -p general -N 1 -t 03-00:00:00 -o step0_trim_short.out --mem=8g --wrap="R CMD BATCH step0_trim_short.R step0_trim_short.Rout"
#srun --mem=24g --time=8:00:00 --pty tcsh
...
#
  ...
  #if(!file.exists(samout))
  write.table(samcov, samout, row.names=F, col.names=F, quote=F)
